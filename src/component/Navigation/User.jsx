...
function User() {
  ...
  return (
    <div>
      <div
        className=" p-2  text-black font-medium hover:rounded-full 
         hover:cursor-pointer text-2xl hover:bg-[#DB4444] m-1"
      >
        <AiOutlineUser className="text-4xl" onClick={() => setfirst(!first)} />
      </div>
      {first && (
        <div
        ...
        >
          <div className="py-1">
            <a
              href="#"
              className="group flex items-center px-4 py-2  hover:bg-white hover:text-black"
            >
              <AiOutlineUser className="mr-3 h5 w-5" aria-hidden="true" />
              <div className=" text-xl">Manage My Account</div>
            </a>
            <a
              href="#"
              className="  hover:bg-white hover:text-black group flex items-center px-4 py-2"
            >
              <FaJediOrder className="mr-3 h5 w-5" aria-hidden="true" />
              <div className=" text-xl">My Order</div>
            </a>
            <a
              href="#"
              className=" hover:bg-white hover:text-black group flex items-center px-4 py-2"
            >
              <AiFillExclamationCircle
                className="mr-3 h5 w-5"
                aria-hidden="true"
              />
              <div className=" text-xl">My Cancellations</div>
            </a>
            <a
              href="#"
              className=" hover:bg-white hover:text-black group flex items-center px-4 py-2"
            >
              ...
              <div className=" text-xl">My Reviews</div>
            </a>
            <a
              href="#"
              className=" hover:bg-white hover:text-black group flex items-center px-4 py-2"
