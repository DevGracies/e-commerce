    ...
    return (
        ...
        {click && (
                ...
                right-0 fixed pr-10 z-10 cursor-pointer list-none">
                 ...
                 hover:bg-black hover:text-white -mt-24" > Contact </Link>
                    <Link className=" -mt-4 text-2xl text-black font-medium 
                h-10 pl-3 ml-3 pr-2 rounded hover:bg-black hover:text-white" to="/About" > About </Link>
                    <Link to="/SignUp" className=" -mt-56ssssssss text-2xl 
                ...
                <Link to="/" className=" m-1 text-2xl  text-black font-medium"> Home </Link>
                <Link to="/Contact" className="m-1 text-2xl  text-black font-medium"> Contact </Link>
                <Link className=" m-1 text-2xl  text-black font-medium" to="/About"> About </Link>
                <Link to="/SignUp" className="m-1 text-2xl  text-black font-medium"> Sign-Up </Link>
            </ul>
